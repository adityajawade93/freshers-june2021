...
describe("subject routes tests", function () {
    ...
    test('test case 1', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(index_1["default"]).get('/class')];
                case 1:
                    res = _a.sent();
    ...
    test('test case 2', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(index_1["default"]).get('/cass')];
                case 1:
                    res = _a.sent();
    ...
    test('test case 3', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(index_1["default"]).get('/class/11')];
                case 1:
                    res = _a.sent();
                    expect(res.status).toBe(200);
    ...
    test('test case 4', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(index_1["default"]).get('/class/ab')];
                case 1:
                    res = _a.sent();
    ...
    test('test case 5', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(index_1["default"]).get('/cass/10')];
                case 1:
                    res = _a.sent();
                    expect(res.status).toBe(404);
                    expect(res.text).toBe("Not Found");
