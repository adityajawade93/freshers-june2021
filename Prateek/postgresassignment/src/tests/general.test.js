...
describe("subject routes tests", function () {
    ...
    test('test case 1', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(index_1["default"]).get('/topclass/10/topsubject/201')];
                case 1:
                    res = _a.sent();
    ...
    test('test case 2', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(index_1["default"]).get('/topclass/abc/topsubject/"ab"')];
                case 1:
                    res = _a.sent();
    ...
    test('test case 3', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(index_1["default"]).get('/class/10/subject/201')];
                case 1:
                    res = _a.sent();
