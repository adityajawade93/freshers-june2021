...
describe("subject routes tests", function () {
    ...
    test("test case 1", function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(index_1["default"]).get("/subject")];
                case 1:
                    res = _a.sent();
    ...
    test("test case 2", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(index_1["default"]).get("/subjectdd")];
                case 1:
                    res = _a.sent();
    ...
    test("test case 3", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    subjectId = 201;
                    return [4 /*yield*/, request(index_1["default"]).get("/subject/" + subjectId)];
                case 1:
                    res = _a.sent();
                    expect(res.status).toBe(200);
    ...
    test("test case 5", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    studentId = 1001;
                    return [4 /*yield*/, request(index_1["default"]).get("/marks/" + studentId)];
                case 1:
                    res = _a.sent();
                    expect(res.status).toBe(200);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, request(index_1["default"]).post("/createsubject").send(data)];
                case 1:
                    res = _a.sent();
                    expect(res.status).toBe(200);
