    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                res = [];
                return [4 /*yield*/, Promise.all(pageIndexes.map(function (index) {
                        page = index;
                        return axios(options);
                    }))];
            case 2:
                res = _a.sent();
                res.map(function (data_list) {
            ...
            case 3:
                ...
                return [3 /*break*/, 4];
            case 4:
                fs.writeFile("passengers.json", JSON.stringify(arrPassengers), function (err) {
                    if (err)
                        throw err;
                    console.log("done with json");
                });
                json_to_csv.json2csv(arrPassengers, function (err, csv) {
                    if (err) {
                        throw err;
                    }
