...
export async function addMark(requestData: markSchemaI): Promise<boolean | Error> {
    try {
...
export async function updateMark(requestData: markSchemaI): Promise<boolean | Error> {
    try {
